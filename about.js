...
let inscritos = [112, 182, 734, 54, 528, 528, 528, 613, 409, 305, 96, 219, 391, 232, 54, 634, 383, 19, 1231, 313, 563, 609 ];
 let certificados = [54, 54, 469, 50, 294, 377, 417, 234, 287, 221, 32, 125, 237, 133, 50, 306, 283, 18, 815, 92, 348, 110 ];
...
//contador//
 ...
 createCounter('counter2', 1000, 50, 5000, 50);
 createCounter('counter3', 1, 1, 20, 172);
 createCounter('counter4', 1000, 100, 7300, 70);
